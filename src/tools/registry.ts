/**
 * Tool registry for Togo Law MCP Server.
...
import { getTogoleseImplementations, type GetTogoleseImplementationsInput } from './get-togolese-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including Togo Law (National Council for Law Reporting). ' +
    ...
    'Call this FIRST when you need to understand what Togolese legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Togolese statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (article) from an Togolese proclamation or regulation. ' +
  ...
  },
  {
    ...
    description:
      'Validate an Togolese legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Togolese statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Togo?" ' +
  ...
  },
  {
    ...
    description:
      'Format a Togolese legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether an Togolese proclamation or provision is currently in force, amended, or repealed. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get the EU/international legal basis that a Togolese statute aligns with or references. ' +
      'Togo is not an EU member but several Togolese laws were influenced by EU regulations ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Togolese statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_togolese_implementations',
    description:
      'Find all Togolese statutes that align with or implement a specific EU directive or regulation. ' +
      'Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns matching Togolese statutes. ' +
      'Note: Togo implements international standards through domestic legislation influenced by international frameworks.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that have Togolese implementing/aligning legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_togolese_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents with Togolese aligning legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU/international legal basis for a SPECIFIC provision within a Togolese statute. ' +
  ...
  },
  {
    ...
    description:
      'Check EU/international alignment status for a Togolese statute or provision. ' +
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_togolese_implementations':
          result = await getTogoleseImplementations(db, args as unknown as GetTogoleseImplementationsInput);
          break;
